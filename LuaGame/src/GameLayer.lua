...
function GameLayer:createLayer()
  print("createlayer")
  local layer = GameLayer:new() --建立新layer
  layer:init()
  return layer
end
...
function GameLayer:Joypadcontrol()
  --設定八方向
...
function GameLayer:buttonClick()
...
function GameLayer:btnClickCallback()
